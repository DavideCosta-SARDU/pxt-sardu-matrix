...
namespace sarduMatrix {
    ...
    //% matrix.shadow=variables_get matrix.defl=matrix text.defl="Hello" x.defl=0 y.defl=0 firstColor.shadow=neopixel_colors secondColor.shadow=neopixel_colors direction.defl=MatrixWipeDirection.LeftToRight font.defl=MatrixFont.Sardu size.defl=MatrixFontSize.X1 brightness.min=0 brightness.max=255 brightness.defl=128 orientation.defl=MatrixTextOrientation.Normal
    export function drawGradientText(
        matrix: Matrix,
        text: string,
        x: number = 0,
    ...
    //% matrix.shadow=variables_get matrix.defl=matrix text.defl="Hello" x.defl=0 y.defl=0 color.shadow=neopixel_colors firstBrightness.min=0 firstBrightness.max=255 firstBrightness.defl=128 finalBrightness.min=0 finalBrightness.max=255 finalBrightness.defl=8 direction.defl=MatrixWipeDirection.LeftToRight font.defl=MatrixFont.Sardu size.defl=MatrixFontSize.X1 orientation.defl=MatrixTextOrientation.Normal
    ...
    //% matrix.shadow=variables_get matrix.defl=matrix text.defl="Hello" edge.defl=MatrixScrollEdge.Right firstColor.shadow=neopixel_colors secondColor.shadow=neopixel_colors direction.defl=MatrixWipeDirection.LeftToRight frameIntervalMs.min=0 frameIntervalMs.defl=100 font.defl=MatrixFont.Sardu size.defl=MatrixFontSize.X1 brightness.min=0 brightness.max=255 brightness.defl=128 orientation.defl=MatrixTextOrientation.Normal mode.defl=MatrixScrollMode.Exclusive
    export function scrollGradientTextFromEdge(
        matrix: Matrix,
        text: string,
    ...
    //% matrix.shadow=variables_get matrix.defl=matrix text.defl="Hello" edge.defl=MatrixScrollEdge.Right color.shadow=neopixel_colors firstBrightness.min=0 firstBrightness.max=255 firstBrightness.defl=128 finalBrightness.min=0 finalBrightness.max=255 finalBrightness.defl=8 direction.defl=MatrixWipeDirection.LeftToRight frameIntervalMs.min=0 frameIntervalMs.defl=100 font.defl=MatrixFont.Sardu size.defl=MatrixFontSize.X1 orientation.defl=MatrixTextOrientation.Normal mode.defl=MatrixScrollMode.Exclusive
    ...
    //% matrix.shadow=variables_get matrix.defl=matrix text.defl="Hello" startX.defl=-1 startY.defl=0 endX.defl=0 endY.defl=0 firstColor.shadow=neopixel_colors secondColor.shadow=neopixel_colors direction.defl=MatrixWipeDirection.LeftToRight frameIntervalMs.min=0 frameIntervalMs.defl=100 font.defl=MatrixFont.Sardu size.defl=MatrixFontSize.X1 brightness.min=0 brightness.max=255 brightness.defl=128 orientation.defl=MatrixTextOrientation.Normal mode.defl=MatrixScrollMode.Exclusive
    export function scrollGradientTextBetween(
        matrix: Matrix,
        text: string,
        startX: number,
    ...
    //% compileHiddenArguments=true inlineInputMode="variable" inlineInputModeLimit=7 expandableArgumentBreaks="5"
    //% matrix.shadow=variables_get matrix.defl=matrix text.defl="Hello" startX.defl=-1 startY.defl=0 endX.defl=0 endY.defl=0 color.shadow=neopixel_colors firstBrightness.min=0 firstBrightness.max=255 firstBrightness.defl=128 finalBrightness.min=0 finalBrightness.max=255 finalBrightness.defl=8 direction.defl=MatrixWipeDirection.LeftToRight frameIntervalMs.min=0 frameIntervalMs.defl=100 font.defl=MatrixFont.Sardu size.defl=MatrixFontSize.X1 orientation.defl=MatrixTextOrientation.Normal mode.defl=MatrixScrollMode.Exclusive
    ...
    //% matrix.shadow=variables_get matrix.defl=matrix icon.defl=MatrixIcon.FilledHeart x.defl=0 y.defl=0 color.shadow=neopixel_colors size.min=1 size.max=4 size.defl=1 brightness.min=0 brightness.max=255 brightness.defl=128
