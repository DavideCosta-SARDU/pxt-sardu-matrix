...
namespace sarduMatrix {
    ...
    //% matrix.shadow=variables_get matrix.defl=matrix x1.defl=0 y1.defl=0 x2.defl=7 y2.defl=7 color.shadow=neopixel_colors
    ...
    //% matrix.shadow=variables_get matrix.defl=matrix centerX.defl=7 centerY.defl=7 radius.defl=4 radius.min=0 color.shadow=neopixel_colors
